          ...
          <div id="rev_slider_home" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
            <ul>
              ...
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x1125" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="Make an Impact">
                <!-- MAIN IMAGE -->
                <img src="{{url('sliders/'.$slider->slider_image)}}" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                <!-- LAYERS -->
                <!-- LAYER NR. 1 -->
          ...
          <div class="row equal-height">
            <div class="col-sm-4 col-md-4">
              <div class="icon-box-new bg-white text-center clearfix m-0 pr-20 pl-20 pt-30 pb-20 mb-40">
                ...
                <a class="text-black-999" href="{{ route('about', 'best-laptop')}}">Read More...</a>
              </div>
            </div>
            <div class="col-sm-4 col-md-4">
              <div class="icon-box-new bg-white text-center clearfix m-0 pr-20 pl-20 pt-30 pb-20 mb-40">
                ...
                <p>Lorem ipsum dolor sit amet elit. Duis erat nec. Ut lobortis, magna nec rhoncus, neque quam mattis ipsum, vel erat velit at diam.</p>
                <a class="text-black-999" href="{{ route('about', 'best-teacher')}}">Read More...</a>
              </div>
            </div>
            <div class="col-sm-4 col-md-4">
              <div class="icon-box-new bg-white text-center clearfix m-0 pr-20 pl-20 pt-30 pb-20 mb-40">
                ...
                <p>Lorem ipsum dolor sit amet elit. Duis erat nec. Ut lobortis, magna nec rhoncus, neque quam mattis ipsum, vel erat velit at diam.</p>
                <a class="text-black-999" href="{{ route('about','best-library')}}">Read More...</a>
              </div>
            </div> 
          </div>
        </div>
                        ...
                        @foreach ($home_courses as $ho_course)
                          ...
                          <div class="col-sm-4 col-md-4 col-lg-4 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            <div class="services mb-xs-30">
                              <div class="thumb">
                                <img class="img-fullwidth" alt="" width="480px" height="180px" src="{{url('courses_images/'.$ho_course->course_image)}}">
                              </div>
                              <div class="services-details clearfix">
                                <div class="p-20 p-sm-15 bg-lighter">
                                  ...
                                  @if(Auth::check())
                                    @if(!empty($ho_course->card_status))
                                      <a class="btn btn-info btn-theme-colored btn-sm text-uppercase mt-10 disabled" disabled href="{{url('/add_to_card/'.$ho_course->course_id)}}">Add To Cart</a>
                                    @else
                                    <a class="btn btn-info btn-theme-colored btn-sm text-uppercase mt-10" href="{{url('/add_to_card/'.$ho_course->course_id)}}">Add To Cart</a>
                                  @endif
                                  @endif
                                  
                                    @if(Auth::check())
                                          @if(!empty($ho_course->status) )
                                         
                                            <a href="#" class="btn btn-danger disabled" style="margin-top: 10px" disabled><span>+ Add to Wish List</span></a>
                                          @else
                                          <a href="{{ route('add_to_wishlist',['slug'=>$ho_course->course_name.'-'.$ho_course->course_id]) }}" class="btn btn-danger" style="margin-top: 10px"><span>+ Add to Wish List</span></a>
...
<script>
  $(document).ready(function(){
      ...
      function getCourses(page){
        $.ajax({
              url:'/ajax/getCourses?page='+ page,
              dataType: "xml",
              }).done(function(home_courses){
                $('.container').html(home_courses);
              });
